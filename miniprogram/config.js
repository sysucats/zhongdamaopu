...
module.exports = {
  ...
  app_version: "v1.9.9",
  // laf后台服务地址
  laf_url: 'https://b3yfaf.laf.run',
  // laf后台服务地址（开发环境），一般和上面laf_url一致就好
  laf_dev_url: 'https://b3yfaf.laf.run',
  // 使用私有的腾讯云cos存储，需要url签名
  use_private_tencent_cos: true,

  // 科普页图片
  science_imgs: [
    "https://oss.laf.run/b3yfaf-cat/系统/科普1.png",
    "https://oss.laf.run/b3yfaf-cat/系统/科普2.png",
    "https://oss.laf.run/b3yfaf-cat/系统/科普3.png",
    "https://oss.laf.run/b3yfaf-cat/系统/科普4.png",
    "https://oss.laf.run/b3yfaf-cat/系统/科普5.png"
  ],

  // 赞赏码图片
  reward_img: "https://oss.laf.run/b3yfaf-cat/系统/赞赏码.jpg",
  // 新猫问卷图片
  feedback_wj_img: "https://oss.laf.run/b3yfaf-cat/系统/新猫问卷.png",
  // 小程序菊花码图片
  mpcode_img: "https://oss.laf.run/b3yfaf-cat/系统/菊花码.jpg",
